...
Request URL:http://order.mi.com/buy/confirm?id=1160201135704612
Request Method:GET
Status Code:200 OK
*/
...
Custom-Status:0
Date:Mon, 01 Feb 2016 02:20:14 GMT
...
<link rel="stylesheet" type="text/css" href="//s01.mifile.cn/css/pay-confirm.min.css?v=2015122101" />
...
<script type="text/javascript">
var _confirmConfig = {
    order_id:'1160201135704612',
    safe_tel:'',
    goods_amount:'1891.00'
};
</script>
    ...
    <div class="container confirm-box">
            ...
            <div class="section section-order">
                <div class="order-info clearfix">
                    <div class="fl">
                        ...
                        <p class="order-time">请在<span class="pay-time-tip">2小时0分</span>内完成支付, 超时后将取消订单</p>
                        <p class="post-info" id="J_postInfo">
                                                        收货信息：谭圣斌 137****7501 &nbsp;&nbsp;
                            广东&nbsp;&nbsp;阳江市&nbsp;&nbsp;阳东县&nbsp;&nbsp;东城镇湖滨东路一街七巷7号                                                    </p>
                    </div>
                    <div class="fr">
                        <p class="total">
                            应付总额：<span class="money"><em>1891.00</em>元</span>
                        </p>
                ...
                <div class="order-detail">
                    <ul>
                        ...
                        <li class="clearfix">
                            ...
                            <div class="content">
                            谭圣斌 137****7501&nbsp;&nbsp;
                            广东&nbsp;&nbsp;阳江市&nbsp;&nbsp;阳东县&nbsp;&nbsp;东城镇湖滨东路一街七巷7号                            </div>
                                                    </li>
                        <li class="clearfix">
                            <div class="label">商品名称：</div>
                            <div class="content">
                                小米手机4移动4G版 16GB 白色<br/>必备套装                            </div>
                        </li>
                                                <li class="clearfix">
            ...
            <div class="section section-payment">
                ...
                <div class="payment-box ">
                    ...
                    <div class="payment-body">
                        <ul class="clearfix payment-list J_paymentList J_linksign-customize">
                                                        <li class="J_bank"><input type="radio" name="payOnlineBank" id="unionpay" value="unionpay" /> <img src="//s01.mifile.cn/i/banklogo/unionpay.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="cft" value="cft" /> <img src="//s01.mifile.cn/i/banklogo/cft.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="micash" value="micash" /> <img src="//s01.mifile.cn/i/banklogo/micash.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="alipay" value="alipay" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_zfb.png?ver2015" alt=""/></li>                        </ul>
                                            </div>
                </div>
                ...
                <div class="payment-box ">
                    ...
                    <div class="payment-body">
                        <ul class="clearfix payment-list payment-list-much J_paymentList J_linksign-customize">
                            <li class="J_bank"><input type="radio" name="payOnlineBank" id="CMB" value="CMB" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_zsyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="ICBCB2C" value="ICBCB2C" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_gsyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="CCB" value="CCB" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_jsyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="ABC" value="ABC" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_nyyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="BOCB2C" value="BOCB2C" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_zgyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="COMM" value="COMM" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_jtyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="PSBC-DEBIT" value="PSBC-DEBIT" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_youzheng.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="GDB" value="GDB" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_gfyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="SPDB" value="SPDB" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_pufa.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="CEBBANK" value="CEBBANK" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_gdyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="SPABANK" value="SPABANK" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_payh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="CIB" value="CIB" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_xyyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="CMBC" value="CMBC" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_msyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="BOB" value="BOB" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_bjyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="CITIC" value="CITIC" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_zxyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="SDB" value="SDB" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_sfyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="SHBANK" value="SHBANK" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_shyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="BJRCB" value="BJRCB" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_bjnsyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="NBBANK" value="NBBANK" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_nbyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="HZCBB2C" value="HZCBB2C" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_hzyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="SHRCB" value="SHRCB" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_shnsyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="FDB" value="FDB" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_fcyh.png?ver2015" alt=""/></li>                            <li class="J_showMore">
                ...
                <div class="payment-box payment-box-last ">
                    ...
                    <div class="payment-body">
                        <ul class="clearfix payment-list  J_paymentList J_linksign-customize">
                            <li class="J_bank"><input type="radio" name="payOnlineBank" id="CMB-KQ" value="CMB-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_zsyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="SPABANK-KQ" value="SPABANK-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_payh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="CCB-KQ" value="CCB-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_jsyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="ICBCB2C-KQ" value="ICBCB2C-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_gsyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="CITIC-KQ" value="CITIC-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_zxyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="CEBBANK-KQ" value="CEBBANK-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_gdyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="BOCB2C-KQ" value="BOCB2C-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_zgyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="SRCB-KQ" value="SRCB-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_shncsyyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="JSB-KQ" value="JSB-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_jiangsshuyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="CMBC-KQ" value="CMBC-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_msyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="CIB-KQ" value="CIB-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_xyyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="ABC-KQ" value="ABC-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_nyyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="SDB-KQ" value="SDB-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_sfyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="HXB-KQ" value="HXB-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_hyyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="GDB-KQ" value="GDB-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_gfyh.png?ver2015" alt=""/></li><li class="J_bank"><input type="radio" name="payOnlineBank" id="BOB-KQ" value="BOB-KQ" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_bjyh.png?ver2015" alt=""/></li>                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="payment-box">
                    <div class="payment-header clearfix">
                        <h3 class="title">信用卡分期付款</h3>
                        <span class="desc">（支持的金额在 1400~8000元 的订单）</span>
                    </div>
                    <div class="payment-body">
                        <ul class="clearfix payment-list J_paymentList J_linksign-customize J_tabSwitch">
                            <li class="J_bank fenqi" data-isinstalment="true"><input autocomplete="off" type="radio" name="payOnlineBank" id="cmbinstal" value="cmbinstal" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_zsyh.png" alt=""/></li><li class="J_bank fenqi" data-isinstalment="true"><input autocomplete="off" type="radio" name="payOnlineBank" id="CCB-INSTAL" value="CCB-INSTAL" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_jsyh.png" alt=""/></li><li class="J_bank fenqi" data-isinstalment="true"><input autocomplete="off" type="radio" name="payOnlineBank" id="ICBCB2C-INSTAL" value="ICBCB2C-INSTAL" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_gsyh.png" alt=""/></li><li class="J_bank fenqi" data-isinstalment="true"><input autocomplete="off" type="radio" name="payOnlineBank" id="ABC-INSTAL" value="ABC-INSTAL" /> <img src="//s01.mifile.cn/i/banklogo/payOnline_nyyh.png" alt=""/></li>                        </ul>
                        <div class="tab-container clearfix isinstalment-box">
                                                        <div class="tab-content  clearfix">
                                                                <div class="isinstalment-item  clearfix">
                                    <div class="item-header">
                                        <h3>3期 ，每期约 653.03元</h3>
                                        <p>
                                           手续费 68.08元，
                                           共 1959.08元
                                        </p>
                                    ...
                                    <div class="item-body">
                                        <ul>
                                            ...
                                            <li class="clearfix">
                                                <span>需手续费：</span>
                                                <p>68.08元 ≈ 1891.00元 × 3.6%</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>实付金额：</span>
                                                <p>1959.08元  =  1891.00元（订单应付金额）+  68.08元（手续费）</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>每期需付：</span>
                                                <p>653.03元 = 1959.08元 ÷ 3期</p>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="item-body">
                                        <ul>
                                            ...
                                            <li class="clearfix">
                                                <span>需手续费：</span>
                                                <p>90.77元 ≈ 1891.00元 × 4.8%</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>实付金额：</span>
                                                <p>1981.77元  =  1891.00元（订单应付金额）+  90.77元（手续费）</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>每期需付：</span>
                                                <p>330.3元 = 1981.77元 ÷ 6期</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="item-footer">
                                    ...
                                    <div class="item-body">
                                        <ul>
                                            ...
                                            <li class="clearfix">
                                                <span>需手续费：</span>
                                                <p>136.15元 ≈ 1891.00元 × 7.2%</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>实付金额：</span>
                                                <p>2027.15元  =  1891.00元（订单应付金额）+  136.15元（手续费）</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>每期需付：</span>
                                                <p>168.93元 = 2027.15元 ÷ 12期</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="item-footer">
                                    ...
                                    <div class="item-body">
                                        <ul>
                                            ...
                                            <li class="clearfix">
                                                <span>需手续费：</span>
                                                <p>28.37元 ≈ 1891.00元 × 1.5%</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>实付金额：</span>
                                                <p>1919.37元  =  1891.00元（订单应付金额）+  28.37元（手续费）</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>每期需付：</span>
                                                <p>639.79元 = 1919.37元 ÷ 3期</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="item-footer">
                                    ...
                                    <div class="item-body">
                                        <ul>
                                            ...
                                            <li class="clearfix">
                                                <span>需手续费：</span>
                                                <p>37.82元 ≈ 1891.00元 × 2%</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>实付金额：</span>
                                                <p>1928.82元  =  1891.00元（订单应付金额）+  37.82元（手续费）</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>每期需付：</span>
                                                <p>321.47元 = 1928.82元 ÷ 6期</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="item-footer">
                                    ...
                                    <div class="item-body">
                                        <ul>
                                            ...
                                            <li class="clearfix">
                                                <span>需手续费：</span>
                                                <p>75.64元 ≈ 1891.00元 × 4%</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>实付金额：</span>
                                                <p>1966.64元  =  1891.00元（订单应付金额）+  75.64元（手续费）</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>每期需付：</span>
                                                <p>163.89元 = 1966.64元 ÷ 12期</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="item-footer">
                                    ...
                                    <div class="item-body">
                                        <ul>
                                            ...
                                            <li class="clearfix">
                                                <span>需手续费：</span>
                                                <p>22.69元 ≈ 1891.00元 × 1.2%</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>实付金额：</span>
                                                <p>1913.69元  =  1891.00元（订单应付金额）+  22.69元（手续费）</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>每期需付：</span>
                                                <p>637.9元 = 1913.69元 ÷ 3期</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="item-footer">
                                    ...
                                    <div class="item-body">
                                        <ul>
                                            ...
                                            <li class="clearfix">
                                                <span>需手续费：</span>
                                                <p>34.04元 ≈ 1891.00元 × 1.8%</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>实付金额：</span>
                                                <p>1925.04元  =  1891.00元（订单应付金额）+  34.04元（手续费）</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>每期需付：</span>
                                                <p>320.84元 = 1925.04元 ÷ 6期</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="item-footer">
                                    ...
                                    <div class="item-body">
                                        <ul>
                                            ...
                                            <li class="clearfix">
                                                <span>需手续费：</span>
                                                <p>39.71元 ≈ 1891.00元 × 2.1%</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>实付金额：</span>
                                                <p>1930.71元  =  1891.00元（订单应付金额）+  39.71元（手续费）</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>每期需付：</span>
                                                <p>321.79元 = 1930.71元 ÷ 6期</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="item-footer">
                                    ...
                                    <div class="item-body">
                                        <ul>
                                            ...
                                            <li class="clearfix">
                                                <span>需手续费：</span>
                                                <p>73.75元 ≈ 1891.00元 × 3.9%</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>实付金额：</span>
                                                <p>1964.75元  =  1891.00元（订单应付金额）+  73.75元（手续费）</p>
                                            </li>
                                            <li class="clearfix">
                                                <span>每期需付：</span>
                                                <p>163.73元 = 1964.75元 ÷ 12期</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="item-footer">
                        ...
                        <div class="isinstalment-desc">
                            分期付款说明：<br>
                            每期还款金额是根据你的订单估算得出的金额，实际支付数额请以银行账单为准，银行有权决定是否接受您的分期付款申请。
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade modal-hide modal-pay-tip" id="J_payTip" aria-hidden="false">
    ...
    <div class="modal-body clearfix">
        <div class="success">
            <h4>支付成功了</h4>
            <p><a href="http://order.mi.com/user/orderView/1160201135704612">立即查看订单详情 &gt;</a></p>
        </div>
        <div class="fail">
            <h4>如果支付失败</h4>
...
<script type="text/javascript" src="//s01.mifile.cn/js/payConfirm.min.js?v=2015122101"></script>
